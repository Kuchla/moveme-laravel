...
<ol class="breadcrumb">
    ...
    <li>
        <a href="{{ route('admin.cities.index') }}">{{ trans("adminlte::pages.account.crud") }}</a>
    </li>
    ...
    <div class="col-xs-12">
        <div class="box box-success">
            <div class="box-header">
                ...
                <form method="POST" action="{{ route('admin.admins.update', $admin) }}" role="form" enctype="multipart/form-data">
                    @method('PATCH')
